...
var y = 25.0
//y = x
//An error occurs when I uncomment the third line, we cannot assign type Int to type Double. Inorder to resolve we must change type Int to type Double.
